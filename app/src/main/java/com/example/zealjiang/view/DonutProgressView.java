...
public class DonutProgressView extends View {
    ...
    private final int default_finished_color = Color.parseColor("#FFFA323C");
    private final int default_unfinished_color = Color.parseColor("#33FA323C");
    private final int default_text_color = Color.parseColor("#ffffffff");
    private final int default_inner_bottom_text_color = Color.parseColor("#ffffffff");
    ...
    public DonutProgressView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        default_text_size = ScreenUtils.spConvertPx(getContext(), 18);
        min_size = ScreenUtils.dipConvertPx(getContext(), 100);
        default_stroke_width = ScreenUtils.dipConvertPx(getContext(), 10);
        default_inner_bottom_text_size = ScreenUtils.spConvertPx(getContext(), 18);
    ...
    protected void initByAttributes(TypedArray attributes) {
        ...
        attributeResourceId = attributes.getResourceId(R.styleable.DonutProgressView_donut_inner_drawable, 0);
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
        ...
        innerBottomTextHeight = getHeight() * 0.25f;
    }
